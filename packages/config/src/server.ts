...
export const serverEnvironmentSchema = z
  .object({
    ...
    OPENAI_TRANSCRIPTION_MODEL: z.string().min(1).max(120).default('gpt-4o-mini-transcribe'),
    OPENAI_TTS_MODEL: z.string().min(1).max(120).default('gpt-4o-mini-tts'),
    OPENAI_TTS_VOICE: z.string().min(1).max(80).default('marin'),
    OPENAI_AUDIO_TIMEOUT_MS: z.coerce.number().int().min(1_000).max(120_000).default(30_000),
